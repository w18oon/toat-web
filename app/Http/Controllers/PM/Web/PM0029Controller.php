...
class PM0029Controller extends BaseController
{
    public function index()
    {
        ...
        group by flv1.lookup_code, msi.segment1, flv1.description, pt.tobacco_group, pt.subinventory_code,pt.locator_code, pt.primary_uom_code, sr.min_qty, sr.max_qty";

        return $this->vue('pm0029', [
